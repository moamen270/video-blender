...
| publishing + creator analytics via platform APIs (`docs/PLATFORM_APIS.md`) | 🟡 Meta live (FB/IG publish + insights); YouTube live (Analytics + private uploads); TikTok numbers live (sandbox), publishing pending (review) |
